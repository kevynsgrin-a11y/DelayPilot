/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4a20b12ecb653814a164bcc9f7335d4a)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
	CACHE: KVNamespace;
	DB: D1Database;
	ALERT_QUEUE: Queue;
	ALERT_QUEUE_DLQ: Queue;
	RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	DELAYPILOT_ENV: "development";
	DEMO_MODE_ENABLED: "true";
	DOCUMENT_UPLOADS_ENABLED: "false";
	TURNSTILE_SECRET_KEY: string;
	TURNSTILE_SITE_KEY: string;
	ENCRYPTION_PRIMARY_KEY: string;
	HMAC_IDENTIFIER_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DELAYPILOT_ENV" | "DEMO_MODE_ENABLED" | "DOCUMENT_UPLOADS_ENABLED" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_SITE_KEY" | "ENCRYPTION_PRIMARY_KEY" | "HMAC_IDENTIFIER_KEY" | "SESSION_SIGNING_KEY">> {}
}

...
| `apps/web/src/components/**`, `apps/web/src/islands/**`, `apps/web/src/layouts/**`, `apps/web/src/app/**`, `apps/web/src/lib/markdown/**`, `apps/web/astro.config.mjs`, `packages/ui/src/patterns/**`                                                  | `frontend-ui-engineer`                                                                                           |
...
| `apps/edge/wrangler.jsonc`, `apps/edge/worker-configuration.d.ts` (generated by `wrangler types`, never hand-edited), `vercel.json`, `.github/workflows/**`, `packages/observability/**`, `docs/DEPLOYMENT.md`, `docs/RUNBOOK.md`, `docs/ANALYTICS.md` | `platform-release-sre`                                                                                           |

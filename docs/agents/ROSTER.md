...
| `apps/web/src/styles/**`, `packages/ui/src/primitives/**`, `packages/ui/src/tokens/**` | `brand-design-director` |
...
| `packages/rights-engine/**`, `data/rights/rulesets/**` | `rights-rules-engineer` |
...
| `apps/web/src/lib/seo/**`, `apps/web/public/robots.txt`, `sitemap*`, `apps/web/public/security.txt`, `apps/web/public/llms.txt`, `scripts/seo/**`, `docs/SEO.md` | `seo-engineer` |
...
| `docs/PERFORMANCE.md`, `scripts/perf/**`, performance budget configs | `performance-engineer` |
| `apps/edge/wrangler.jsonc`, `.github/workflows/**`, `packages/observability/**`, `docs/DEPLOYMENT.md`, `docs/RUNBOOK.md`, `docs/ANALYTICS.md` | `platform-release-sre` |
...
| `.env.example` | `principal-architect` writes the file; every agent files a handoff to add a key |

...
| `apps/edge/wrangler.jsonc`, `apps/edge/worker-configuration.d.ts` (generated by `wrangler types`, never hand-edited), `vercel.json`, `apps/web/vercel.json`, `.github/workflows/**`, `scripts/validate-security-headers.mjs`, `packages/observability/**`, `docs/DEPLOYMENT.md`, `docs/RUNBOOK.md`, `docs/ANALYTICS.md` | `platform-release-sre`                                                                                           |
